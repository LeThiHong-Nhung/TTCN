...
<?php
    ...
    if (isset($_SESSION['deleteplace'])) {
            echo $_SESSION['deleteplace']; //hien thi thong bao
            unset($_SESSION['deleteplace']); //xoa bo thong bao
        }
    ...
    if (isset($_SESSION['remove'])) {
            echo $_SESSION['remove']; //hien thi thong bao
            unset($_SESSION['remove']); //xoa bo thong bao
        }
?>
<!-- echo session here -->
            ...
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-5" style="position:relative;z-index:1;">
                        <h2><b>Quản lí điểm đến</b></h2>
                    </div>
                    <div class="col-sm-7">
                        <a href="<?php echo SITEURL; ?>admin/addplace.php" class="btn btn-secondary" name="addplace"><i class="material-icons">&#xE147;</i> <span>Thêm điểm đến</span></a>
                        <a href="<?php echo SITEURL; ?>admin/export-place.php" class="btn btn-secondary"><i class="material-icons">&#xE24D;</i> <span>Xuất Excel</span></a>
                    </div>
                </div>
            </div>
            ...
            <table class="table table-striped table-hover">
                ...
                ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo SITEURL; ?>admin/updateplace.php?madiemden=<?php echo $madiemden; ?>&tenanh=<?php echo $tenanh; ?>" class="edit" title="Chỉnh sửa thông tin" data-toggle="tooltip"><i class="material-icons">edit</i></a>
                                    <a href="<?php echo SITEURL; ?>admin/deleteplace.php?madiemden=<?php echo $madiemden; ?>&tenanh=<?php echo $tenanh; ?>" class="delete" title="Xoá điểm đến" data-toggle="tooltip"><i class="material-icons">delete</i></a>
                                    <a href="<?php echo SITEURL; ?>admin/detailplace.php?madiemden=<?php echo $madiemden; ?>&tenanh=<?php echo $tenanh; ?>" class="info" title="Thông tin chi tiết" data-toggle="tooltip"><i class="material-icons">info</i></a>
                                </td>
                            </tr>
