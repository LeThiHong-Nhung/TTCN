            ...
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-5" style="position:relative;z-index:1;">
                        <h2><b>Cập nhật phương tiện</b></h2>
                    </div>
                    <div class="col-sm-7">
                        <a href="<?php echo SITEURL; ?>export-pt.php" class="btn btn-secondary"><i class="material-icons">&#xE24D;</i> <span>Xuất Excel</span></a>
                    </div>
                </div>
            </div>
            ...
            <table class="table table-striped table-hover">
                ...
                ?>
                            ...
                            <tr>
                                ...
                                <td><?php echo $mota; ?></td>
                                <td>
                                    <a href="<?php echo SITEURL; ?>updatept.php?maphuongtien=<?php echo $maphuongtien; ?>" class="edit" title="Edit" data-toggle="tooltip"><i class="material-icons">edit</i></a>
                                </td>
                            </tr>
