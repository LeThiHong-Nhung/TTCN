    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            <div class="table-title">
                <div class="row">
                    <div class="col-sm-5" style="position:relative;z-index:1;">
                        <h2><b>Cập nhật tour</b></h2>
                    </div>
                    <div class="col-sm-7">
                        <a href="<?php echo SITEURL; ?>export-tour.php" class="btn btn-secondary"><i class="material-icons">&#xE24D;</i> <span>Xuất Excel</span></a>
                    </div>
                </div>
            </div>
            ...
            <table class="table table-striped table-hover">
                ...
                if (isset($_POST['tim'])) {
                    $search = $_POST['search'];
                    $sql = "SELECT * FROM danhsachtour WHERE matour LIKE '%$search%' OR tentour LIKE '%$search%' OR giatour LIKE '%$search%' OR mota LIKE '%$search%' LIMIT $offset, $rowsPerPage ";
                ...
                ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?php echo SITEURL; ?>updatetour.php?matour=<?php echo $matour; ?>" class="edit" title="Chỉnh sửa thông tin tour" data-toggle="tooltip"><i class="material-icons">edit</i></a>
                                    <a href="<?php echo SITEURL; ?>detailtour.php?matour=<?php echo $matour; ?>" class="info" title="Thông tin chi tiết" data-toggle="tooltip"><i class="material-icons">info</i></a>
                                </td>
                            </tr>
