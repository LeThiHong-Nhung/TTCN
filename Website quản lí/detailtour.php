...
<?php
        if(isset($_GET['matour']))
        {
            ...
            if($count==1)
            {
                ...
                $sqlp="SELECT GROUP_CONCAT(b.tendiemden) as tendiemden
                FROM tour_diemden a join diemden b on a.madiemden=b.madiemden
                WHERE a.matour='$matour' GROUP BY a.matour ";
                $resp=mysqli_query($conn, $sqlp);
                $rowp=mysqli_fetch_assoc($resp);
                $tendiemden=$rowp['tendiemden'];

                //tìm các phuong tien lien quan
                $sqld="SELECT GROUP_CONCAT(b.tenphuongtien) as tenphuongtien
            ...
            else
            {
                ...
                header('location:'.SITEURL.'tour.php');
            }
        }
        else
        {
    ...
    <div class="table-responsive">
        <div class="table-wrapper">
            ...
            <table class="table table-striped table-hover">
                ...
                <tr>
                        <td>Điểm đến</td>
                        <td colspan="3"><textarea type="text" rows="3" cols="72" readonly name="diemden"><?php echo $tendiemden; ?></textarea></td>
                        <td>Hình ảnh</td>
                        <td>
                        <div>
                            <?php
